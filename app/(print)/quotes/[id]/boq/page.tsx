      ...
      <body>
        ...
        <div className="page">
          ...
          <div className="header">
            <div>
              <div className="company-name">Vyara Tiles Limited</div>
              <div className="company-sub">Vyara, Gujarat · GST: 24AABCV1234F1Z5</div>
            </div>
          ...
          <div className="signature">
            <div className="sig-block">
              <div className="sig-line">Prepared by · Vyara Tiles Limited</div>
            </div>
            <div className="sig-block">
          ...
          <div className="footer">
            Vyara Tiles Limited · Vyara, Gujarat · This document was generated by Vyara OS
          </div>
        </div>
      </body>
    </html>
