...
>
> **Last updated:** 2026-06-20 (Customer 360 Slice 2.1 — Orders tab. REL-009 still ✅ Partial. Read-model + page extended per the Slice 1.6 pattern: one limited list query + one lightweight aggregate. Sales orders queried via `sales_order.buyer_firm_id` direct. Slice 2.2 next: Invoices.)
