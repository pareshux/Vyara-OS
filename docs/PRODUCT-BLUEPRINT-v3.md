...
>
> **Last updated:** 2026-06-21 (INT-014 Slice 4 shipped — Owner Dashboard /owner field + people: Sections 11 Today's field activity (4-status strip + 3-KPI activity row for today), 12 Team roster (live per-rep status, sorted on-duty/wfh/leave/no-record, deep-link → /field/team/[userId]), 13 Rep scorecards (top 5 by visits-with-outcome in period, with km + expense + on-duty days + completion-% chip + 2 honest gap markers for FLD-023 live GPS and visit→closed-₹ attribution). Read-model adds 6 new queries (field-eligible reps, today's attendance/visits/expenses, period's attendance/visits/expenses rollups). Slices 1–4 shipped; Slice 5 = Drill-down filters + Quick Actions + saved views.)
